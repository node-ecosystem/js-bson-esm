...
/** @public */
type EJSONSerializeOptions = EJSONOptionsBase & {
  /**
...
/** @public */
type EJSONParseOptions = EJSONOptionsBase & {
  /**
...
/** @public */
type EJSONOptions = EJSONSerializeOptions & EJSONParseOptions;
/**
...
/** @internal */
declare const BSON_MAJOR_VERSION = 7;
/** @internal */
declare const BSON_VERSION_SYMBOL: unique symbol;
/** @public */
...
//#endregion
//#region src/bson_value.d.ts
/** @public */
type BSONTypeTag = 'BSONRegExp' | 'BSONSymbol' | 'ObjectId' | 'Binary' | 'Decimal128' | 'Double' | 'Int32' | 'Long' | 'MaxKey' | 'MinKey' | 'Timestamp' | 'Code' | 'DBRef';
/** @public */
declare const bsonType: unique symbol;
/** @public */
...
declare class UUID extends Binary {
  ...
  /** @internal */
  static bytesFromString(representation: string): Uint8Array<ArrayBufferLike>;
  /**
   * @internal
   *
...
declare class ObjectId extends BSONValue {
   ...
   */
  private static validateHexString;
...
/** @public */
type TimestampOverrides = '_bsontype' | 'toExtendedJSON' | 'fromExtendedJSON' | 'inspect' | typeof bsonType;
/** @public */
type LongWithoutOverrides = new (low: unknown, high?: number | boolean, unsigned?: boolean) => { [P in Exclude<keyof Long, TimestampOverrides>]: Long[P] };
/** @public */
...
//#endregion
//#region src/parser/deserializer.d.ts
/** @public */
...
//#endregion
//#region src/parser/serializer.d.ts
/** @public */
...
//#endregion
//#region src/utils/byte_utils.d.ts
/**
 * @public
 * @experimental
 *
 ...
 */
type ByteUtils = {
  /** Checks if the given value is a Uint8Array. */isUint8Array: (value: unknown) => value is Uint8Array; /** Transforms the input to an instance of Buffer if running on node, otherwise Uint8Array */
  toLocalBufferType: (buffer: Uint8Array | ArrayBufferView | ArrayBuffer) => Uint8Array; /** Create empty space of size */
  allocate: (size: number) => Uint8Array; /** Create empty space of size, use pooled memory when available */
  allocateUnsafe: (size: number) => Uint8Array; /** Compare 2 Uint8Arrays lexicographically */
  compare: (buffer1: Uint8Array, buffer2: Uint8Array) => -1 | 0 | 1; /** Concatenating all the Uint8Arrays in new Uint8Array. */
  concat: (list: Uint8Array[]) => Uint8Array; /** Copy bytes from source Uint8Array to target Uint8Array */
  copy: (source: Uint8Array, target: Uint8Array, targetStart?: number, sourceStart?: number, sourceEnd?: number) => number; /** Check if two Uint8Arrays are deep equal */
  equals: (a: Uint8Array, b: Uint8Array) => boolean; /** Create a Uint8Array from an array of numbers */
  fromNumberArray: (array: number[]) => Uint8Array; /** Create a Uint8Array from a base64 string */
  fromBase64: (base64: string) => Uint8Array; /** Create a Uint8Array from a UTF8 string */
  fromUTF8: (utf8: string) => Uint8Array; /** Create a base64 string from bytes */
  toBase64: (buffer: Uint8Array) => string; /** **Legacy** binary strings are an outdated method of data transfer. Do not add public API support for interpreting this format */
  fromISO88591: (codePoints: string) => Uint8Array; /** **Legacy** binary strings are an outdated method of data transfer. Do not add public API support for interpreting this format */
  toISO88591: (buffer: Uint8Array) => string; /** Create a Uint8Array from a hex string */
  fromHex: (hex: string) => Uint8Array; /** Create a lowercase hex string from bytes */
  toHex: (buffer: Uint8Array) => string; /** Create a string from utf8 code units, fatal=true will throw an error if UTF-8 bytes are invalid, fatal=false will insert replacement characters */
  toUTF8: (buffer: Uint8Array, start: number, end: number, fatal: boolean) => string; /** Get the utf8 code unit count from a string if it were to be transformed to utf8 */
  utf8ByteLength: (input: string) => number; /** Encode UTF8 bytes generated from `source` string into `destination` at byteOffset. Returns the number of bytes encoded. */
  encodeUTF8Into: (destination: Uint8Array, source: string, byteOffset: number) => number; /** Generate a Uint8Array filled with random bytes with byteLength */
  randomBytes: (byteLength: number) => Uint8Array; /** Interprets `buffer` as an array of 32-bit values and swaps the byte order in-place. */
 ...
 * @experimental
 */
declare const ByteUtils: ByteUtils;
//#endregion
//#region src/utils/number_utils.d.ts
/**
 * @experimental
 * @public
 *
 ...
 */
type NumberUtils = {
  /** Is true if the current system is big endian. */isBigEndian: boolean;
  /**
 ...
 */
declare class BSONError extends Error {
  /**
   * @internal
 ...
 * @category Error
 */
declare class BSONVersionError extends BSONError {
 ...
 *
 */
declare class BSONRuntimeError extends BSONError {
...
//#endregion
//#region src/parser/on_demand/parse_to_elements.d.ts
/**
 * @public
 * @experimental
 */
...
//#endregion
//#region src/parser/on_demand/index.d.ts
/**
 * @experimental
 * @public
 *
 ...
 * @public
 */
declare const onDemand: OnDemand;
declare namespace bson_d_exports {
  export { BSONError, BSONOffsetError, BSONRegExp, BSONRegExpExtended, BSONRegExpExtendedLegacy, BSONRuntimeError, BSONSymbol, BSONSymbolExtended, BSONType, BSONTypeTag, BSONValue, BSONVersionError, Binary, BinaryExtended, BinaryExtendedLegacy, BinarySequence, ByteUtils, CalculateObjectSizeOptions, Code, CodeExtended, DBRef, DBRefLike, Decimal128, Decimal128Extended, DeserializeOptions, Document, Double, DoubleExtended, EJSON, EJSONOptions, EJSONOptionsBase, EJSONParseOptions, EJSONSerializeOptions, Int32, Int32Extended, Long, LongExtended, LongWithoutOverrides, LongWithoutOverridesClass, MaxKey, MaxKeyExtended, MinKey, MinKeyExtended, NumberUtils, ObjectId, ObjectIdExtended, ObjectIdLike, OnDemand, SerializeOptions, Timestamp, TimestampExtended, TimestampOverrides, UUID, UUIDExtended, bsonType, calculateObjectSize, deserialize, deserializeStream, onDemand, serialize, serializeWithBufferAndIndex, setInternalBufferSize };
}
/** @public */
interface Document {
  [key: string]: any;
 ...
 * @public
 */
declare function setInternalBufferSize(size: number): void;
/**
 ...
 * @public
 */
declare function serialize(object: Document, options?: SerializeOptions): Uint8Array;
/**
 ...
 * @public
 */
declare function serializeWithBufferAndIndex(object: Document, finalBuffer: Uint8Array, options?: SerializeOptions): number;
/**
 ...
 * @public
 */
declare function deserialize(buffer: Uint8Array, options?: DeserializeOptions): Document;
/** @public */
 ...
 * @public
 */
declare function calculateObjectSize(object: Document, options?: CalculateObjectSizeOptions): number;
/**
 ...
 * @public
 */
declare function deserializeStream(data: Uint8Array | ArrayBuffer, startIndex: number, numberOfDocuments: number, documents: Document[], docStartIndex: number, options: DeserializeOptions): number;
//#endregion
export { bson_d_exports as BSON, BSONError, BSONOffsetError, BSONRegExp, type BSONRegExpExtended, type BSONRegExpExtendedLegacy, BSONRuntimeError, BSONSymbol, type BSONSymbolExtended, BSONType, type BSONTypeTag, BSONValue, BSONVersionError, Binary, type BinaryExtended, type BinaryExtendedLegacy, type BinarySequence, ByteUtils, CalculateObjectSizeOptions, Code, type CodeExtended, DBRef, type DBRefLike, Decimal128, type Decimal128Extended, type DeserializeOptions, Document, Double, type DoubleExtended, EJSON, type EJSONOptions, type EJSONOptionsBase, type EJSONParseOptions, type EJSONSerializeOptions, Int32, type Int32Extended, Long, type LongExtended, type LongWithoutOverrides, type LongWithoutOverridesClass, MaxKey, type MaxKeyExtended, MinKey, type MinKeyExtended, NumberUtils, ObjectId, type ObjectIdExtended, type ObjectIdLike, type OnDemand, type SerializeOptions, Timestamp, type TimestampExtended, type TimestampOverrides, UUID, type UUIDExtended, bsonType, calculateObjectSize, deserialize, deserializeStream, onDemand, serialize, serializeWithBufferAndIndex, setInternalBufferSize };